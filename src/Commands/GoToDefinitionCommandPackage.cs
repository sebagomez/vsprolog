//------------------------------------------------------------------------------
// <copyright file="GoToDefinitionCommandPackage.cs" company="Company">
...
namespace sebagomez.VSProlog.Commands
{
	...
	public sealed class GoToDefinitionCommandPackage : AsyncPackage
	{
		...
		/// </summary>
		public const string PackageGuidString = "56881429-f0fd-4110-a142-20dfd02338e5";

		/// <summary>
		/// Initializes a new instance of the <see cref="GoToDefinitionCommand"/> class.
		/// </summary>
		public GoToDefinitionCommandPackage()
		{
